...
<section id="content" class="m-t-lg wrapper-md animated fadeInDown scrollable wrapper"> 
    <div class="row">
        <div class="col-lg-4">
            <section class="panel">
                <header class="panel-heading bg bg-primary text-center">Bienvenue dans l'installation de Tendoo</header>
        ...
        <div class="col-lg-3">
            <section class="panel">
                <header class="panel-heading bg bg-danger text-center">Tendoo pour appareil mobile</header>
...
<footer id="footer">
    <div class="text-center padder clearfix">
        <p> <small><?php echo $this->core->tendoo->getVersion();?><br>
            © 2013</small> </p>
    </div>
</footer>
</body>

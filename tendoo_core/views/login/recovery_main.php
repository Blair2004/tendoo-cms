            ...
            <div class="col-lg-6 col-lg-offset-3">
                <section class="panel">
                    ...
                    <section class="chat-list panel-body">
                        ...
                        <ul>
                        	<li>Le compte n'est pas eninstance actif</li>
                        ...
                        <a href="<?php echo $this->instance->url->site_url(array('login','recovery','password_lost'));?>" class="btn btn-primary">Mot de passe oubli&eacute;</a>
                        <a href="<?php echo $this->instance->url->site_url(array('login','recovery','receiveValidation'));?>" class="btn btn-info">Recevoir mail d'activation</a>
                    </section>
                </section>
            </div>
        </div>

...
<section id="content">
    <div class="row m-n">
        ...
        <div class="col-sm-8 col-sm-offset-2">
        	<?php echo Tendoo_info('Bienvenue sur tendoo. Si vous voyez cette page, cela signifie que le CMS est présent sur ce domaine, mais pas encore install&eacute;.<br>

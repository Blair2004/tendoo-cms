        ...
        <div class="col-lg-12">
          <div class="panel">
            <div class="panel-body">
              <h1 class="smb smh">Vos premiers pas sur <?php echo $this->tendoo->getVersion();?></h1>
              <br/>
              <div class="row">
                <div class="col-lg-2"> <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_1.JPG');?>" /> </div>
                <div class="col-lg-10">
          ...
          <div class="panel">
            <div class="panel-body">
              ...
              <div class="row">
                <div class="col-lg-5"> <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_2.JPG');?>" />
                  <hr class="line line-dashed" />
                  <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_3.JPG');?>" /> </div>
                <div class="col-lg-7">
                  ...
                  <p><a href="<?php echo $this->core->url->site_url(array('admin','pages','create'));?>"><strong>Cr&eacute;ez un nouveau contr&ocirc;leur maintenant</strong></a>, dans cette page vous retrouverez plus d'informations dans la cr&eacute;ation des contr&ocirc;leurs.</p>
          ...
          <div class="panel">
            <div class="panel-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-4"> <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_4.JPG');?>" /> </div>
              </div>
            </div>
          </div>
          <div class="panel">
            <div class="panel-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-6"> <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_5.JPG');?>" /> </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6"> <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_6.JPG');?>" /> </div>
                <div class="col-lg-6">
              ...
              <div class="row">
                ...
                <div class="col-lg-9"> <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_7.JPG');?>" /> </div>
              </div>
              <br />
              <h2 id="tendooFonction">II - a - 2 : G&eacute;rer les cat&eacute;gories</h2>
              <div class="row">
              	<div class="col-lg-3">
                	<img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_8.JPG');?>" />
                    <hr class="line line-dashed" />
                    <img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_9.JPG');?>" />
                </div>
                <div class="col-lg-9">
          ...
          <div class="panel">
            <div class="panel-body">
              <h2 class="smh" id="tendooFonction">III  : G&eacute;rer les th&egrave;mes <small><a href="<?php echo $this->core->url->site_url(array('admin','themes'));?>"><i class="icon-link"></i></a></small></h2>
                ...
                <div class="row">
                <div class="col-lg-6">
                	<img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_10.JPG');?>" />
                </div>
                <div class="col-lg-6">
                	<img style="width:100%;" src="<?php echo $this->core->url->img_url('discover/first_step_11.JPG');?>" />
                </div>
                <div class="col-lg-12">

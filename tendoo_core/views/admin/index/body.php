              ...
              ?>
                ...
                if($appIconApi)
                {
                    foreach($appIconApi as $a)
                    {
                        ...
                        ?>
                                    <div class="tendoo-icon-set" data-toggle="tooltip" data-placement="right" title="<?php echo $a['ICON_MODULE']['HUMAN_NAME'];?>" modal-title="<?php echo $a['ICON_MODULE']['HUMAN_NAME'];?>" data-url="<?php echo $this->url->site_url(array('admin','open','modules',$a['ICON_MODULE']['ID']));?>"> <img class="G-icon" src="<?php echo $this->tendoo_admin->getAppImgIco($a['ICON_MODULE']['NAMESPACE']);?>">

   ...
   <section class="scrollable" id="pjax-container">
      <header>
         <div class="row b-b m-l-none m-r-none">
            ...
            <div class="col-sm-8">
                        <a href="http://tendoo.org/index.php/apprendre/le-panneau-de-configuration/les-privileges-et-les-actions" class="btn btn-lg <?php echo theme_button_class();?>" style="float:right;margin:10px;"><i style="font-size:20px;" class="fa fa-question-circle"></i>
                        </a>
                    </div>
         </div>
      </header>

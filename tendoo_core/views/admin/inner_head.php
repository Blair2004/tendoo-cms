		...
		<header id="headish" class="header b-b <?php echo theme_class();?>">
            <div class="collapse navbar-collapse pull-in">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li data-intro="Profil, messagerie, aide et déconnexion, accédez à ces différents liens en cliquant sur ce menu déroulant." data-step="16" data-position="bottom" class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left m-t-n-xs m-r-xs"> <img src="<?php echo $this->instance->url->img_url('avatar_default.jpg');?>" alt="<?php echo ucwords($this->instance->users_global->current('PSEUDO'));?>"> </span> <?php echo ucwords($this->instance->users_global->current('PSEUDO'));?>, <?php echo $this->instance->users_global->current('PRIVILEGE') == 'NADIMERPUS' ? 'Super administrateur' : 'Administrateur';?> <b class="caret"></b> </a>

                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    	...
                                    	<?php echo tendoo_info('Envoyez votre image dont les dimensions de doivent pas excéder 300px, en largeur et en hauteur.');?>
...
>
                                        ...
                                        <br>
                                        <?php echo tendoo_info('Souhaitez-vous partager votre profil facebook, google+ ou twitter ? Entrez l\'adresse de votre profile.<br><br> Si vous souhaitez utiliser l\'avatar de votre profil, veuillez selectionner le réseau social dont vous souhaitez utiliser l\'avatar.');?>

                                        <div class="input-group"> <span class="input-group-btn">
                                            <button class="btn <?php echo theme_button_class();?>" type="button"><i class="fa fa-facebook"></i></button>
                                            </span>

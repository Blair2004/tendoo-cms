...
class tendoo_theme_tepas_class
{
	public function __construct()
	{
		...
		$config		=	array(
			...
			'each_input_field_class'	=>	'" style="height:auto;',
			'each_textarea_field_class'	=>	'" style="width:100%;',
	...
	{
		$categories	=	array(
			'open_wrapper'	=>	'<div class="well">',
			'close_wrapper'	=>	'</div>',
			'before_title'	=>	'<h4>',
			'after_title'	=>	'</h4>',
			'open_content'	=>	'<div class="row">',
			'close_content'	=>	'</div>',
			'open_parent'	=>	'<div class="span6"><ul class="arrow" style="list-style:none;padding:0;margin:0">',
			'close_parent'	=>	'</ul></div>',
		...
		$tags		=	array(
			...
			'close_parent'	=>	'</ul>',
			'before_item'	=>	'<li style="margin:5px 5px 0 0;display:inline-block">',
			'after_item'	=>	'</li>',
			'item_class'	=>	'btn btn-xs btn-primary btn-small'
		);
		...
		declare_widget( 'right' , 'text' , $text );
	}
	...
	private function set_breadcrumbs()
	{
		...
		declare_bread( array (
				'wrapper'			=>	'ul',
				'wrapper_class'		=>	'breadcrumb pull-right" style="margin-bottom:10px',
				'container'			=>	'div',

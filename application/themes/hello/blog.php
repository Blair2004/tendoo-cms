    ...
    <section id="cd-timeline" class="cd-container">
		...
		<div class="cd-timeline-block">
			<div class="cd-timeline-img cd-picture">
				<img src="<?php echo $theme_uri;?>img/cd-icon-picture.svg" alt="Picture">
			</div> <!-- cd-timeline-img -->

			<div class="cd-timeline-content">
				<h2><?php echo xss_clean( $post[ 'TITLE' ] );?></h2>
				<p><?php echo word_limiter( xss_clean( $post[ 'CONTENT' ] ), 30 );?></p>
				<a href="<?php echo site_url( array( 'blog', $post[ 'POST_SLUG' ] ) );?>" class="cd-read-more"><?php _e( 'Read More', 'hello' );?></a>
        ...
        <div class="cd-timeline-block">
			...
			<div class="cd-timeline-content">
				<h2><?php echo __( 'No Posts', 'hello' );?></h2>
				<p><?php echo sprintf( 
					__( 'No posts yet. Get to dashboard and <a href="%s">start writing</a>', 'hello' ), 
					site_url( array( 'dashboard', 'posttype', 'blog', 'new' ) ) 
				); ?></p>
				<a href="<?php echo site_url( array( 'dashboard', 'posttype', 'blog', 'new' ) );?>" class="cd-read-more"><?php _e( 'Start Writing', 'hello' );?></a>
				<!-- <span class="cd-date">Jan 14</span> -->
			</div> <!-- cd-timeline-content -->
		</div>
		<?php }?>

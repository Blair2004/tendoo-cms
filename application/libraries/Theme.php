	 ...
	 **/
	 ...
	 public static function Run_Theme( $arguments )
	 {
		 if( Modules::is_active( 'post_type' ) ) {
			 ...
			 } else if( $arguments[1] == 'blog' && in_array( @$arguments[2] , array( 'p', '' ) ) ) { // we assume for now that "/blog" slug will load blog.php from Theme folder
			 	// Load blog Index page
				 $CurrentTheme	=	self::Get_Active();	
			 ...
			 } else if( $arguments[1] == 'blog' && @$arguments[2] != 'p' ) {
				 // Load blog Index page
				 $CurrentTheme	=	self::Get_Active();	

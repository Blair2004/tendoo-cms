...
class PostType
{
	...
	**/
	function __construct( $config )
	{
		...
		$this->comments_list_label	=	$this->config[ 'comments-list-label' ]	=	riake( 'comments-list-label' , $config , sprintf( __( '%s comments' ) , $this->namespace ) ); 		$this->is_hierarchical		=	$this->config[ 'is-hierarchical' ]		=	riake( 'is-hierarchical' , $config , true );

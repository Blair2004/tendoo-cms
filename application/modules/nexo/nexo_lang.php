<?php
// System
$lang[ 'license-expired' ]			=	tendoo_error( __( 'Votre licence a expiré. Veuillez contacter l\'administrateur pour renouveller votre license.' ) );
$lang[ 'invalid-activation-key' ]	=	tendoo_error( __( 'La licence que vous avez spécifiée est invalide. La précédente licence a été restaurée. Veuillez contacter l\'administrateur pour corriger le problème.' ) );

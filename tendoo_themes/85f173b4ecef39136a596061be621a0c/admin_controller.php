<?php
class Tendoo_modus_theme_admin_controller
{
	public function __construct($data)
	{
		...
		$this->tendoo_admin->menuExtendsBefore($this->data['Omenu']);
	...
	public function index()
	{
		...
		$this->tendoo->setTitle($this->data['pageTitle']);
		$this->tendoo->setDescription($this->data['pageDescription']);
	...
	{
		$this->data['pageTitle']		=	'A propos d\'Tendoo modus';
		$this->data['pageDescription']	=	'Gesionnaire du th&egrave;me modus';

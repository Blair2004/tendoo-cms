...
trigger_events( 'before_title_inition' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' , $post ) ); // Trigger each event bound
...
trigger_events( 'after_title_inition' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' , $post ) ); // Trigger each event bound

trigger_events( 'before_editor_inition' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' , $post ) ); // Trigger each event bound
...
trigger_events( 'after_editor_inition' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' , $post ) ); // Trigger each event bound

trigger_events( 'before_publish_inition' , array( $current_posttype , $this->gui , $post_namespace . '-create-new-sidebar' , $post ) ); // Trigger each event bound
...
trigger_events( 'after_publish_inition' , array( $current_posttype , $this->gui , $post_namespace . '-create-new-sidebar' , $post ) ); // Trigger each event bound

...
trigger_events( 'before_post_title' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' ) ); // Trigger each event bound
...
trigger_events( 'after_post_title' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' ) ); // Trigger each event bound

trigger_events( 'before_post_editor' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' ) ); // Trigger each event bound
...
trigger_events( 'after_post_editor' , array( $current_posttype , $this->gui , $post_namespace . '-create-new' ) ); // Trigger each event bound

trigger_events( 'before_post_publish' , array( $current_posttype , $this->gui , $post_namespace . '-create-new-sidebar' ) ); // Trigger each event bound
...
trigger_events( 'after_post_publish' , array( $current_posttype , $this->gui , $post_namespace . '-create-new-sidebar' ) ); // Trigger each event bound

...
<div class="col-lg-9">
    <div class="gridster">
      <ul style="margin-top:-5px;">
        <li class="list" data-row="1" data-col="1" data-sizex="1" data-sizey="1">
          <?php
        ...
        <li class="list" data-row="1" data-col="2" data-sizex="1" data-sizey="1">
          <section class="panel no-borders" style="margin-bottom:0;">
        ...
        <li class="list" data-row="1" data-col="1" data-sizex="1" data-sizey="1"></li>
        <li class="list" data-row="3" data-col="1" data-sizex="2" data-sizey="1"></li>
      </ul>
    </div>
    ...
    $(function(){
      ...
      gridster = $(".gridster > ul").gridster({
          ...
          widget_base_dimensions: [375, 213]
      }).data('gridster');
    });
    </script>
</div>

		...
		<header id="headish" class="header b-b <?php if($options[0]['ADMIN_THEME'] == 0):?> bg-primary <?php ;endif;?>">
            <div class="collapse navbar-collapse pull-in">
                ...
                <form class="navbar-form navbar-left m-t-sm" role="search">
                    <a href="javascript:hubby.modal.closable(true).show('BOnjour')" type="submit" class="btn btn-sm btn-white"><i class="icon-shopping-cart"></i>Magasin d'application</a>
                </form>
                ...
                <ul class="nav navbar-nav navbar-right">
					<?php
                    $sysNot			=	$this->core->hubby_admin->get_sys_not();

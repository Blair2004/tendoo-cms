...
<section id="content">
    <div class="row m-n">
        ...
        <div class="col-sm-8 col-sm-offset-2">
        	<p class="hubby_notice">Bienvenue sur Hubby. Si vous voyez cette page, cela signifie que le CMS est présent sur ce domaine, mais pas encore install&eacute;.<br>
            Vous devez proc&eacute;der &agrave; l'installation afin d'utiliser toutes les fonctionnalités du CMS.</p>

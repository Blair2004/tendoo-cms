...
if(!function_exists('notice'))
{
	function notice($e,$sort = FALSE)
	{
		...
		$array['validationSended']		=	'<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button><i style="font-size:18px;margin-right:5px;" class="icon-warning-sign"></i> Un mail d\'activation &agrave; &eacute;t&eacute; envoy&eacute; &agrave; cette addresse.</div>';

...
if(!function_exists('notice'))
{
	function notice($e,$sort = FALSE)
	{
		...
		$array['adminDeleted']				=	'<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button><i style="font-size:18px;margin-right:5px;" class="icon-thumbs-up-alt"></i> L\'administrateur &agrave; &eacute;t&eacute; correctement supprim&eacute;.</div>';
		...
		$array['missingArg']				=	'<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button><i style="font-size:18px;margin-right:5px;" class="icon-warning-sign"></i>Une erreur s\'est produite. Certains &eacute;l&eacute;ment, qui permettent le traitement de votre demande, sont manquant.</div>';
		...
		$array['adminCreated']				=	'<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert"><i class="icon-remove"></i></button><i style="font-size:18px;margin-right:5px;" class="icon-thumbs-up-alt"></i>L\'administrateur &agrave; &eacute;t&eacute; correctement cr&eacute;e</div>';

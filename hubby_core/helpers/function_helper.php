...
if(!function_exists('notice'))
{
	function notice($e,$extends_msg= '',$sort = FALSE)
	{
		...
		$array['module_alreadyExist']		= 	hubby_warning('Ce module &agrave; d&eacute;j&agrave; &eacute;t&eacute; install&eacute;.');	
		$array['unknowModule']				=	hubby_warning('Ce module est introuvable.');
		$array['module_uninstalled']		=	hubby_success('Le module &agrave; &eacute;t&eacute; d&eacute;sinstall&eacute;.');

        ...
        <section class="scrollable" id="pjax-container">
            ...
            <section class="vbox">
                <section class="wrapper"> 
                    ...
                    <?php echo hubby_info('Afin de pouvoir li&eacute;er un contr&ocirc;leur que vous avez cr&eacute;e &agrave; une page HTML, ils est n&eacute;cessiare que ce contr&ocirc;leur ait comme module ce module');?>
                	<section class="panel">
                            ...
                            <table class="table table-striped m-b-none">
                                ...
                                <tbody>
                                    ...
                                    if(is_array($supportedPages))
                                    {
                                        ...
                                        {
                                            $control	=	$this->core->hubby_admin->get_pages($s['PAGE_CNAME']);
                                            $isAttached	=	$rtp_lib->isAttached($s['ID']);
                                            ?>
                                    <tr>
                                        <td><a href="<?php echo $this->core->url->site_url(array('admin','open','modules',$data['_hubby_vars']['module'][0]['ID'],'page_edit',$s['PAGE_CNAME']));?>"><?php echo $s['PAGE_NAMES'];?></a></td>

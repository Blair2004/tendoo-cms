        ...
        <section class="scrollable" id="pjax-container">
            ...
            <section class="vbox">
                <section class="wrapper"> <?php echo $this->core->notice->parse_notice();?> <?php echo $success;?> <?php echo notice_from_url();?> <?php echo validation_errors(); ?>
                    ...
                    ?>
                                <tr>
                                    <td><img style="width:50px;height:50px;" src="<?php echo $this->core->url->main_url().'hubby_modules/'.$data['_hubby_vars']['module'][0]['ENCRYPTED_DIR'].'/content_repository/'.$t['FILE_NAME'];?>" alt="<?php echo $t['FILE_NAME'];?>"></td>

               ...
               <div class="row">
                     ...
                     <section class="panel">
                        <div class="panel-body">
                           <?php
								...
								?>
                           <div class="clearfix m-b"> <small class="text-muted pull-right"><?php echo $this->hubby->timespan($getSpeContact[0]['DATE']);?></small> <a href="#" class="thumb-sm pull-left m-r"> <img src="" class="img-circle bg-danger"> </a>
                  ...
                  <?php
                     ...
                     <section class="panel">
                        ...
                        <div class="panel-body">
                        	<?php echo hubby_warning('Vous ne pouvez faire vous faire un message &agrave; vous m&ecirc;me..');?>
                        </div>
                     </section>
                        <?php
							}
                     ...
                     <section class="panel">
                        <div class="panel-heading">Erreur</div>
                        <div class="panel-body">
                        	<?php echo hubby_warning('Cet utilisateur n\'est pas inscrit pour recevoir une r&eacute;ponse.');?>
                        </div>
                     </section>
                     <?php
						}

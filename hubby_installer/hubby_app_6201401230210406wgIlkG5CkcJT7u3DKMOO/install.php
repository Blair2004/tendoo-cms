...
$this->appTableField(array(
	'NAMESPACE'		=> 'hubby_contact_handler',
...
$this->appSql(	
'CREATE TABLE IF NOT EXISTS `hubby_contact_handler` (
...
$this->appSql(	
'CREATE TABLE IF NOT EXISTS `hubby_contact_handler_option` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
$this->appSql(	
'CREATE TABLE IF NOT EXISTS `hubby_contact_fields` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
$this->appSql(	
'CREATE TABLE IF NOT EXISTS `hubby_contact_aboutUs` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `FIELD_CONTENT` text,

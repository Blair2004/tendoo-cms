          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="panel">
                ...
                <div class="panel-body"> 
					<form method="post">
					<?php echo tendoo_info('Remplissez les informations qui vous concerne, ou votre entreprise ou votre activ&eacute;');?> <?php echo $this->instance->tendoo->getEditor(array(

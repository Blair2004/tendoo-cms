        ...
        <footer class="footer bg-white b-t">
            <div class="row m-t-sm text-center-xs">
                <div class="col-lg-3 pull-right">
                    <input type="button" link-to-form="#submition" class="btn btn-sm pull-right <?php echo theme_button_class();?>" value="Modifier la page">
                </div>
            </div>
        </footer>
                            ...
                            <div class="col-lg-8">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group textarea"> <?php echo $this->instance->visual_editor->getEditor(array('name'=>'page_content','id'=>'editor','defaultValue'	=>	$current_page[0][ 'FILE_CONTENT' ] ));?> </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group text">
                                            <textarea class="form-control" rows="5" type="text" name="page_description" placeholder="Description" style="resize:none;"><?php echo return_if_array_key_exists( 'DESCRIPTION' , $current_page[0] );?></textarea>
                                        </div>
                                        <div class="form-group text">
                                            <select class="form-control" rows="5" type="text" name="page_parent">
												...
												if( is_array( $available_pages ) ){
													foreach( $available_pages as $_page ){
														...
														?><option <?php echo $is_selected;?> value="<?php echo $_page[ 'ID' ];?>"><?php echo $_page[ 'TITLE' ];?></option><?php
													}
												}
												?>
                                            </select>
                                        ...
                                        <div class="form-group text">
                                            ...
                                            <span></span>
                                            <p style="display:inline-block;vertical-align:bottom;font-weight:normal;margin-left:10px;">Publier</p>
                                            </label>
                                        </div>
                                    </div>
                                </div>

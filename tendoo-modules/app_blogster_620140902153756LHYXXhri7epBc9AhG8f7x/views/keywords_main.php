    ...
    <section class="hbox stretch"><?php echo $inner_head;?>
        <footer class="footer bg-white b-t">
            <div class="row m-t-sm text-center-xs">
                ...
                <div class="col-sm-4 text-center"> <small class="text-muted inline m-t-sm m-b-sm">Affiche <?php echo $paginate['start'];?> &agrave; <?php echo $paginate['end'];?> &eacute;l&eacute;ments</small> </div>
                <div class="col-sm-2">
            ...
            <section class="hbox stretch">
                <section class="wrapper"> 
                    ...
                    <div class="row">
                    	<div class="col-lg-8">
                    <section class="panel">
                        <div class="panel-heading"> Liste des mots clés disponibles </div>

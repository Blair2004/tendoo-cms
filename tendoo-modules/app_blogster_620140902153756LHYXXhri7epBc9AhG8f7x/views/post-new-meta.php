<section class="panel">
    ...
    <div class="panel-body">
		...
		<div class="form-group">
        	<div class="row">
            	<div class="col-lg-4">
                <input type="text" name="scheduledTime" class="input-sm input-s form-control" placeholder="12:30">
                </div>
                <div class="col-lg-6">
                <input class="input-sm input-s datepicker form-control" size="16" value="<?php echo get_instance()->date->datetime('%d-%m-%Y');?>" type="text" style="margin-right:10px;" name="scheduledDate">
                </div>
            </div>
        </div>
        <div class="form-group">

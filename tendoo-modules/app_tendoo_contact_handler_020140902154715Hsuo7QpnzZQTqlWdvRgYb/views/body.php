                        ...
                        <table class="table table-striped b-t text-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th>Membre du site <?php echo $options['site_name'];?></th>
                                    <th>Email</th>
							...
							if($retreiContact)
							{
								...
								?>
                                <tr>
                                	<td><a href="<?php echo $this->url->site_url(array('admin','open','modules',$module['namespace'],'check',$f['ID']));?>"><?php echo $f['USER_NAME'];?></a></td>
                                    ...
                                    <td><a href="<?php echo $this->url->site_url(array('admin','open','modules',$module['namespace'],'delete',$f['ID']));?>">Supprimer</a></td>
                                </tr>
                                <?php
								}
							}

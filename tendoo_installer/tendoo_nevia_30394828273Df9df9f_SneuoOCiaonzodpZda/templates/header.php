    ...
    <ul class="menu" id="responsive">
	  	<?php foreach($controllers as $c)	{ ?>
        	<?php if($c["PAGE_CNAME"] == $this->url->controller())	{ ?>
                ...
                <li class="active"><a href="<?php echo $c["PAGE_LINK"];?>" title="<?php echo $c["PAGE_TITLE"];?>"><?php echo ucwords($c["PAGE_NAMES"]);?></a><?php $this->menu->getControllerSubmenu($c);?></li>
                <?php } else { ?>
                <li class="active"><a href="<?php echo $this->url->site_url(array($c["PAGE_CNAME"]));?>" title="<?php echo $c["PAGE_TITLE"];?>"><?php echo ucwords($c["PAGE_NAMES"]);?></a><?php $this->menu->getControllerSubmenu($c);?></li>
                <?php } ?>
			<?php } else { ?>
            	<?php if($c["PAGE_MODULES"] == "#LINK#")	{ ?>
                <li class="active"><a href="<?php echo $c["PAGE_LINK"];?>" title="<?php echo $c["PAGE_TITLE"];?>"><?php echo ucwords($c["PAGE_NAMES"]);?></a><?php $this->menu->getControllerSubmenu($c);?></li>
                <?php } else { ?>
                <li class=""><a href="<?php echo $this->url->site_url(array($c["PAGE_CNAME"]));?>" title="<?php echo $c["PAGE_TITLE"];?>"><?php echo ucwords($c["PAGE_NAMES"]);?></a><?php $this->menu->getControllerSubmenu($c);?></li>
                <?php } ?>
            <?php } ?>                
        <?php } ?>
    </ul>

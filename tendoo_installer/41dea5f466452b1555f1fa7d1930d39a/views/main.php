                            ...
                            <section class="panel">
                                <header class="panel-heading bg-light">
                                    <ul class="nav nav-tabs nav-justified">
                                        <li class="active"><a href="#caroussel" data-toggle="tab">Caroussel</a></li>
                                        <li><a href="#lastestelement" data-toggle="tab">élements récents</a></li>
                                        <li><a href="#featuredelement" data-toggle="tab">Elements au top</a></li>
                                        <li><a href="#tabshowcase" data-toggle="tab">Dossier d'éléments</a></li>
                                        <li><a href="#listelement" data-toggle="tab">Liste d'éléments</a></li>
                                        <li><a href="#galleryshowcase" data-toggle="tab">Galerie d'éléments</a></li>
                                        <li><a href="#aboutus" data-toggle="tab">A propos de nous</a></li>
                                    </ul>
                                </header>
                                <div class="panel-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="caroussel">home</div>
                                        <div class="tab-pane active" id="lastestelement">home</div>
                                        <div class="tab-pane active" id="featuredelement">home</div>
                                        <div class="tab-pane active" id="tabshowcase">home</div>
                                        <div class="tab-pane active" id="listelement">home</div>
                                        <div class="tab-pane" id="galleryshowcase">profile</div>
                                        <div class="tab-pane" id="aboutus">message</div>

        ...
        <section class="scrollable" id="pjax-container">
            ...
            <section class="vbox">
                <section class="wrapper"> <?php echo output('notice');?>  <?php echo fetch_error_from_url();?> <?php echo validation_errors(); ?>
                    ...
                    ?>
                                <tr>
                                    <td><img style="width:50px;height:50px;" src="<?php echo $this->instance->url->main_url().'tendoo_modules/'.$opened_module['encrypted_dir'].'/content_repository/'.$t['FILE_NAME'];?>" alt="<?php echo $t['FILE_NAME'];?>"></td>
                                    ...
                                    <td><a href="<?php echo $this->instance->url->main_url().'tendoo_modules/'.$opened_module['encrypted_dir'].'/content_repository/'.$t['FILE_NAME'];?>"><?php echo $t['FILE_NAME'];?></a></td>

                            ...
                            <div class="panel-body">
                                <div class="col-lg-12">
                                    <form method="post" class="form">
										...
										?>
                                            ...
                                            <?php echo $this->core->tendoo->getEditor(array('name'=>'aboutUsContent','defaultValue'	=>	$default1));?>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <form method="post" class="form">
                                        ...
                                        <div class="form-group">
                                            <label class="label-control">Nos partenaires</label>
                                            <?php echo $this->core->tendoo->getEditor(array('name'=>'ourPartner','defaultValue'	=>	$default2));?>
                                        </div>

								...
								?>
									<tr>
										<td class="action articlePanel" style="padding-top:10px;padding-bottom:10px">
											<strong>
											<a class="view" href="<?php echo $this->instance->url->site_url(array('admin','open','modules',$module[ 'namespace' ],'edit',$g['ID']));?>"><?php echo $g['TITLE'];?></a>
											</strong>
											...
											<small><a data-doAction style="color:#FF7F7F" href="<?php echo $this->instance->url->site_url(array('admin','open','modules',$module[ 'namespace' ],'delete',$g['ID']));?>">Supprimer</a></small>

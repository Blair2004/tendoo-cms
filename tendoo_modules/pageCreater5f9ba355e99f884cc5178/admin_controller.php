...
class Pages_editor_admin_controller
{
	...
	{
		$this->tendoo->setTitle('Page Editor - Page d\'administration');
		
		$this->data['countPages']		=	count($this->page_handler->getPages());
		$this->data['paginate']			=	$this->core->tendoo->paginate(10,$this->data['countPages'],1,'bg-color-blue fg-color-white','bg-color-white fg-color-blue',$page,$this->core->url->site_url(array('admin','open','modules',$this->moduleData['ID'],'index')).'/',$ajaxis_link=null);
	...
	public function create()
	{
		...
		$this->tendoo->setTitle('Page Editor - Créer une nouvelle page');
	...
	{
		$this->tendoo->setTitle('Attributeur de contenu - Page d\'administration');
	...
	public function page_edit($page)
	{
		...
		$this->data['control']		=	$this->core->tendoo_admin->get_pages($page);

...
class UUID
{
	 ...
	 * @return  string
	 * @throws InvalidArgumentException when invalid namespace given
	 */
	protected static function toBin($namespace)
	{
		if (! static::validate($namespace)) {
			throw new InvalidArgumentException('Provided namespace is not a valid UUID.');
		}
	...
	public static function v3($namespace, $name)
	{
		...
		$hash = md5(static::toBin($namespace) . $name);

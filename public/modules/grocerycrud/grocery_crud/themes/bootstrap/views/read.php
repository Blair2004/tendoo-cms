<?php
	...
	$this->set_css($this->default_theme_path.'/bootsrap/css/flexigrid.css');
	$this->set_js_lib($this->default_theme_path.'/bootsrap/js/jquery.form.js');
	$this->set_js_config($this->default_theme_path.'/bootsrap/js/flexigrid-edit.js');
